...
# Purpose
# ---------------------------------------------------------------------
# This script reproduces the empirical results reported in the article,
# including:
# - Descriptive statistics (Table 1)
# - Beta regression estimates (Table 2)
# - Model fit statistics (AIC, BIC, Pseudo R2, Nagelkerke R2)
# - Observed versus predicted values (Figure 1 (b)))
#
# ---------------------------------------------------------------------
# Data
# ---------------------------------------------------------------------
...
#
# Software:
# R statistical computing environment (R Core Team)
# Packages: betareg, moments
# =====================================================================
...
df <- read.csv("data_for_submission.csv", stringsAsFactors = FALSE)


# ---------------------------------------------------------------------
# check domain of dependent variable
# ---------------------------------------------------------------------
...
# likelihood-based Nagelkerke R2
